...
func TestFindConflict(t *testing.T) {
	...
	for i, tt := range tests {
		raftLog := newLog(NewMemoryStorage(), raftLogger, nil, 0)
...
func TestAppend(t *testing.T) {
	...
	for i, tt := range tests {
		...
		raftLog := newLog(storage, raftLogger, nil, 0)
...
func TestStableToWithSnap(t *testing.T) {
	...
	for i, tt := range tests {
		...
		raftLog := newLog(s, raftLogger, nil, 0)
...
func TestIsOutOfBounds(t *testing.T) {
	...
	l := newLog(storage, raftLogger, nil, 0)
